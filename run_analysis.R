...
# side note:
#in case the instructions really mean "evalaute mean and standard deviations" for each subject and activity, then one can use the aggregate function as follows
